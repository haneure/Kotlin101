...
public class MainActivity extends Activity {
    ...
    private boolean isEmpty(EditText operandEdit) {
        return operandEdit.getText().toString().isEmpty();
    }
    ...
    private void compute(Calculator.Operator operator) {
        ...
        double operandTwo;
        try {
            //gapake negasi, ada error muncul tulisan error muncul dibawah div
            if (isEmpty(mOperandOneEditText) || isEmpty(mOperandTwoEditText)) {
                mResultTextView.setText("Operand tidak boleh tidak diisi");
                return;
            } else {
